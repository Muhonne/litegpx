...
`09-route-draw-mouseup.sh` covers drag-to-draw, verifies editing can be toggled off/on without breaking drawing, and prevents duplicate endpoints when continuing a route with freehand drawing.
