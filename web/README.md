...
`09-route-draw-mouseup.sh` covers drag-to-draw, stopping draw tracking on mouseup, Shift+drag map panning while editing, editing toggles, and preventing duplicate endpoints when continuing a route with freehand drawing.
