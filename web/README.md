...
`10-mobile-save-button.sh` covers save-to-mobile request payloads, busy button feedback while map data is being generated, immediate route-manager update after save, and preserving the saved route and metadata across stale catalog refreshes.
