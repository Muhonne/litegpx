...
`03-basic-editing.sh` covers imported route editing, newest-first point list behavior with route-order labels, ignoring duplicate endpoint adds and adjacent inserts without consuming undo history, and confirming before clearing unsaved route edits.
