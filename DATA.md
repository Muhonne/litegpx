...
- Android bundled map copy/load: `mobile/app/src/main/java/com/example/traillite/TrailStorage.kt` `ensureBundledMapPackage`, `writeLocalStyle`
...
- Android provider overlay injection: `mobile/app/src/main/java/com/example/traillite/TrailStorage.kt` `providerOverlayPackage`, `addProviderOverlay`
...
This is a local development workflow. It mutates the Android project and shared generated map files so the next APK includes the route and route-corridor map data.
